...
### Design genesis and governance model

Lead collaboration: ChatGPT (OpenAI). Protocol direction, object model
design, ATProto overlay architecture, operator attestation model, anti-scope
discipline, and the pivot from standalone protocol to receipts overlay.

### Implementation, tests, and integration

Lead collaboration: Claude (Anthropic) via Claude Code. Repo scaffolding,
lexicon drafts, documentation, example records, and implementation of the
Rust kernel and Python service layer.
...
This document reflects the project state as of 2026-04-12 and may be revised.
